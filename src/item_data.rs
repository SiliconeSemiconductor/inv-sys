...
pub fn build_item_data() -> HashMap<String, Item> {
    #[rustfmt::skip]let item_collection = HashMap::from([
        ...
        (String::from("Wood"), Item::build_item("Wood", 2.5, "You can burn it, you can build with it, you can also probably eat it", ItemType::Recource, 2, 1)),
        (String::from("Iron Bar"), Item::build_item("Iron Bar", 20.0, "made of iron...", ItemType::Recource, 2, 1)),
    ]);
